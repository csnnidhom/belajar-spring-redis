...
public class SpringRedisApplication {
	...
	@Bean
	public Subscription orderSubsription(StreamMessageListenerContainer<String, ObjectRecord<String, Order>> orderContainer,
		...
		var consumer = Consumer.from("my-group", "consumer");
